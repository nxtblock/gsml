...
:download_mingw
powershell -Command "Invoke-WebRequest -Uri 'http://hk1-proxy.gitwarp.com:8888/https://github.com/OI-liyifan202201/OI-liyifan202201/releases/download/v1.0/MinGW-64.zip' -OutFile 'MinGW.zip'"
if %errorlevel%==1 (
