...
:download_mingw
powershell -Command "Invoke-WebRequest -Uri 'https://git.ppp.ac.cn/https://github.com/Github-liyifan202201/Github-liyifan202201/releases/download/v1.0/MinGW-64.zip' -OutFile 'MinGW.zip'"
if %errorlevel%==1 (
